...
**Last benchmarked at**: _4 mai 2025, 07:07_ (_daily_ updated).
...
| install |       | ✔        |             | 9.2s | 3.8s | 5s | 1.1s | 842ms |
...
| install | ✔     |          |             | 8.7s | 4.2s | 7s | 4.1s | 489ms |
| install |       | ✔        |             | 7.9s | 3.6s | 3.9s | 1.1s | 461ms |
...
| install | ✔     | ✔        | ✔           | 1.2s | 784ms | 1.5s | n/a | 39ms |
| install | ✔     | ✔        |             | 7.2s | 2.3s | 5.4s | 1.3s | 715ms |
| install | ✔     |          |             | 11s | 5.3s | 9.1s | 4.9s | 718ms |
| install |       | ✔        |             | 9.7s | 4.7s | 5.4s | 1.3s | 721ms |
| install | ✔     |          | ✔           | 1.5s | 1.9s | 5.1s | n/a | 38ms |
