...
**Last benchmarked at**: _19 mars 2025, 07:07_ (_daily_ updated).
...
| install | ✔     | ✔        | ✔           | 974ms | 682ms | 981ms | n/a | 28ms |
| install | ✔     | ✔        |             | 3.6s | 1.5s | 2.6s | 852ms | 359ms |
| install | ✔     |          |             | 6.1s | 3.5s | 5.1s | 3.2s | 364ms |
...
| install |       | ✔        | ✔           | 1.1s | 708ms | 1.3s | n/a | 30ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 30.8s | 7.2s | 11.5s | 5.4s | 1.8s |
| install | ✔     | ✔        | ✔           | 1.3s | 787ms | 1.5s | n/a | 41ms |
| install | ✔     | ✔        |             | 7.4s | 2.2s | 5.4s | 1.3s | 723ms |
