...
**Last benchmarked at**: _25 août 2025, 07:08_ (_daily_ updated).
...
| install | ✔     | ✔        | ✔           | 902ms | 688ms | 1.3s | n/a | 28ms |
| install | ✔     | ✔        |             | 7.6s | 1.8s | 5.2s | 1.2s | 834ms |
| install | ✔     |          |             | 10.8s | 4.6s | 6.6s | 2.4s | 809ms |
...
| install |       | ✔        | ✔           | 1.1s | 633ms | 1.3s | n/a | 27ms |
...
| install |       | ✔        |             | 10.2s | 4.9s | 5.7s | 1.3s | 696ms |
