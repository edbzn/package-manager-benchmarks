...
**Last benchmarked at**: _5 mai 2025, 07:08_ (_daily_ updated).
...
| install | ✔     | ✔        |             | 4.9s | 1.8s | 3.4s | 975ms | 466ms |
| install | ✔     |          |             | 8.2s | 4.4s | 6.7s | 4.1s | 458ms |
| install |       | ✔        |             | 7.2s | 3.4s | 3.5s | 969ms | 433ms |
...
| install | ✔     |          |             | 6.1s | 3.6s | 5.2s | 3.2s | 377ms |
| install |       | ✔        |             | 5.4s | 2.8s | 2.7s | 837ms | 358ms |
...
| install | ✔     |          |             | 10.2s | 4.2s | 7.9s | 4s | 842ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 21.2s | 5.8s | 8.7s | 4.6s | 2.2s |
| install | ✔     | ✔        | ✔           | 1.1s | 738ms | 1.3s | n/a | 31ms |
| install | ✔     | ✔        |             | 5.7s | 1.8s | 3.9s | 1.1s | 487ms |
| install | ✔     |          |             | 8.7s | 4.2s | 7s | 4.1s | 494ms |
| install |       | ✔        |             | 7.9s | 3.6s | 3.9s | 1.1s | 470ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 30.2s | 7.6s | 11.5s | 5.4s | 2.6s |
| install | ✔     | ✔        | ✔           | 1.2s | 784ms | 1.5s | n/a | 42ms |
| install | ✔     | ✔        |             | 7.2s | 2.3s | 5.4s | 1.3s | 747ms |
| install | ✔     |          |             | 11s | 5.3s | 9.1s | 4.9s | 764ms |
| install |       | ✔        |             | 9.7s | 4.7s | 5.4s | 1.3s | 734ms |
