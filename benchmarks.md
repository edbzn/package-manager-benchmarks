...
**Last benchmarked at**: _9 juil. 2025, 07:09_ (_daily_ updated).
...
| install |       | ✔        | ✔           | 1.2s | 613ms | 1.2s | n/a | 33ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 17.5s | 4.8s | 5.6s | 2.2s | 1.1s |
| install | ✔     | ✔        | ✔           | 945ms | 568ms | 1s | n/a | 28ms |
| install | ✔     | ✔        |             | 3.7s | 1.5s | 2.7s | 862ms | 330ms |
...
| install |       | ✔        |             | 9.6s | 3.8s | 5.2s | 1.2s | 839ms |
...
| install | ✔     | ✔        | ✔           | 1.2s | 671ms | 1.5s | n/a | 41ms |
