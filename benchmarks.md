...
**Last benchmarked at**: _30 août 2025, 07:06_ (_daily_ updated).
...
| install |       | ✔        |             | 5.6s | 2.8s | 2.8s | 868ms | 329ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 21.2s | 6.5s | 10.8s | 2.8s | 1.7s |
...
| install | ✔     |          |             | 9s | 4.6s | 5.6s | 2.5s | 464ms |
...
| update  | n/a | n/a | n/a | 1.2s | 4s | 5.4s | 2.9s | 94ms |
