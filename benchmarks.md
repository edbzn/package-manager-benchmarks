...
**Last benchmarked at**: _21 juil. 2025, 07:13_ (_daily_ updated).
...
| install | ✔     | ✔        |             | 5s | 1.7s | 3.6s | 982ms | 459ms |
| install | ✔     |          |             | 8.3s | 4.3s | 5s | 2.2s | 428ms |
| install |       | ✔        |             | 7.3s | 3.3s | 3.6s | 973ms | 421ms |
...
| install |       | ✔        |             | 5.5s | 2.7s | 2.7s | 867ms | 341ms |
...
| install |       | ✔        |             | 8.1s | 3.6s | 4.1s | 1.1s | 462ms |
| install | ✔     |          | ✔           | 1.4s | 1.4s | 2.7s | n/a | 31ms |
| install |       | ✔        | ✔           | 1.2s | 601ms | 1.3s | n/a | 29ms |
...
| install | ✔     | ✔        | ✔           | 1.2s | 677ms | 1.5s | n/a | 70ms |
| install | ✔     | ✔        |             | 7.5s | 2.2s | 5.5s | 1.3s | 698ms |
| install | ✔     |          |             | 11.5s | 5.3s | 7.2s | 2.8s | 706ms |
