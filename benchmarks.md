...
**Last benchmarked at**: _22 avr. 2025, 07:08_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 20.6s | 6.2s | 9.4s | 4.4s | 1.4s |
| install | ✔     | ✔        | ✔           | 1.2s | 795ms | 1.1s | n/a | 35ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 20.1s | 4.9s | 6.3s | 3.6s | 1s |
| install | ✔     | ✔        | ✔           | 909ms | 717ms | 962ms | n/a | 27ms |
...
| install |       | ✔        | ✔           | 909ms | 691ms | 957ms | n/a | 25ms |
...
| install |       | ✔        | ✔           | 862ms | 767ms | 1.3s | n/a | 26ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 30.2s | 7.9s | 11.5s | 5.4s | 1.9s |
...
| install | ✔     |          | ✔           | 1.5s | 2.2s | 5.1s | n/a | 40ms |
| install |       | ✔        | ✔           | 1.2s | 806ms | 1.5s | n/a | 35ms |
