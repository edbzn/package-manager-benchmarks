...
**Last benchmarked at**: _3 août 2025, 07:08_ (_daily_ updated).
...
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 21.3s | 6.4s | 9.6s | 2.6s | 1.4s |
| install | ✔     | ✔        | ✔           | 1.2s | 661ms | 1.2s | n/a | 34ms |
| install | ✔     | ✔        |             | 5.1s | 1.7s | 3.6s | 982ms | 435ms |
| install | ✔     |          |             | 8.5s | 4.7s | 5s | 2.2s | 413ms |
| install |       | ✔        |             | 7.6s | 3.4s | 3.6s | 973ms | 416ms |
...
| install | ✔     | ✔        | ✔           | 968ms | 587ms | 1s | n/a | 26ms |
...
| install |       | ✔        | ✔           | 951ms | 564ms | 1s | n/a | 23ms |
| install |       |          | ✔           | 1.1s | 2.7s | 2s | n/a | 23ms |
| update  | n/a | n/a | n/a | 956ms | 2.6s | 7.8s | 2.7s | 26ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 22.6s | 6s | 7.4s | 2.8s | 1.4s |
