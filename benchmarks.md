...
**Last benchmarked at**: _6 mai 2025, 07:08_ (_daily_ updated).
...
| install | ✔     |          |             | 8.2s | 4.4s | 6.7s | 4.1s | 439ms |
...
| install | ✔     |          |             | 10.2s | 4.2s | 7.9s | 4s | 837ms |
...
| install | ✔     |          |             | 11s | 5.3s | 9.1s | 4.9s | 751ms |
