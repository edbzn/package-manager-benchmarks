...
**Last benchmarked at**: _17 févr. 2024, 07:14_ (_daily_ updated).
...
| install | ✔     |          |             | 9.7s | 5.4s | 4.9s | 2.6s | 454ms |
...
| install | ✔     |          |             | 7.3s | 4.8s | 3.9s | 2.1s | 375ms |
...
| update  | n/a | n/a | n/a | 1.3s | 4.6s | 6.6s | 2.6s | 47ms |
...
| install | ✔     | ✔        |             | 7s | 2.6s | 5s | 1.4s | 674ms |
| install | ✔     |          |             | 12.4s | 6.4s | 7s | 3s | 681ms |
| install |       | ✔        |             | 11.7s | 5.7s | 5.1s | 1.4s | 659ms |
