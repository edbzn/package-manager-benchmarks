...
**Last benchmarked at**: _6 mai 2024, 07:06_ (_daily_ updated).
...
| install |       | ✔        |             | 6.5s | 3s | 2.9s | 935ms | 314ms |
...
| action  | cache | lockfile | node_modules| npm | pnpm | Yarn | Yarn PnP | Bun |
| ---     | ---   | ---      | ---         | --- | ---  | ---  | ---      | --- |
| install |       |          |             | 23.5s | 6.7s | 11.3s | 2.9s | 1.8s |
...
| install | ✔     | ✔        |             | 6.1s | 2.1s | 4.1s | 1.2s | 483ms |
| install | ✔     |          |             | 10s | 4.7s | 5.6s | 2.5s | 468ms |
| install |       | ✔        |             | 9.2s | 4s | 4.1s | 1.2s | 455ms |
| install | ✔     |          | ✔           | 1.6s | 1.9s | 2.8s | n/a | 45ms |
| install |       | ✔        | ✔           | 1.3s | 966ms | 1.5s | n/a | 28ms |
...
| update  | n/a | n/a | n/a | 1.4s | 4.6s | 5.4s | 2.9s | 86ms |
