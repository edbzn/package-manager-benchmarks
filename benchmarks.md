...
**Last benchmarked at**: _28 juin 2025, 07:07_ (_daily_ updated).
...
| install |       | ✔        | ✔           | 1.2s | 676ms | 1.2s | n/a | 30ms |
...
| install | ✔     | ✔        |             | 5.9s | 1.8s | 4s | 1.1s | 475ms |
...
| install |       | ✔        | ✔           | 1.2s | 669ms | 1.5s | n/a | 36ms |
