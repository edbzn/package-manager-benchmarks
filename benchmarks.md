...
**Last benchmarked at**: _12 févr. 2024, 07:15_ (_daily_ updated).
...
| install | ✔     |          |             | 11.5s | 4.9s | 6.2s | 2.4s | 753ms |
| install |       | ✔        |             | 10.7s | 4.2s | 4.8s | 1.2s | 721ms |
...
| install | ✔     |          |             | 10s | 4.9s | 5.4s | 2.6s | 399ms |
