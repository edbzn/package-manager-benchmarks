...
**Last benchmarked at**: _13 mai 2025, 07:08_ (_daily_ updated).
...
| install | ✔     | ✔        | ✔           | 1.2s | 770ms | 1.1s | n/a | 33ms |
| install | ✔     | ✔        |             | 4.9s | 1.8s | 3.4s | 974ms | 479ms |
| install | ✔     |          |             | 8.2s | 4.4s | 6.7s | 4.1s | 428ms |
| install |       | ✔        |             | 7.2s | 3.4s | 3.5s | 969ms | 422ms |
...
| install | ✔     | ✔        | ✔           | 871ms | 766ms | 1.3s | n/a | 29ms |
| install | ✔     | ✔        |             | 7.5s | 1.8s | 5.1s | 1.1s | 846ms |
| install | ✔     |          |             | 10.2s | 4.2s | 7.9s | 4s | 805ms |
| install |       | ✔        |             | 9.2s | 3.8s | 5s | 1.1s | 825ms |
| install | ✔     |          | ✔           | 1s | 1.5s | 4.1s | n/a | 29ms |
| install |       | ✔        | ✔           | 862ms | 736ms | 1.3s | n/a | 26ms |
...
| install | ✔     | ✔        |             | 5.7s | 1.8s | 3.9s | 1.1s | 474ms |
| install | ✔     |          |             | 8.7s | 4.2s | 7s | 4.1s | 464ms |
